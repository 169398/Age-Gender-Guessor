...
import HistoryContext, {
  HistoryCtxInterface,
} from "../context/history/history.context";
...
const App = () => {
  ...
  // For Search Bar
  const onlyAllowCharAndMakeProperCase = (
    ...
    <HistoryContext.Provider value={history}>
      <div className="top-container">
        <header className="tc pv3 pv4-ns top-left">
          <h1 className="header-title f-headline-l f1-ns">
      ...
      <div>
        ...
        <footer className="code tc pa3">
          Made by{" "}
          <a className="footer-link" href="https://github.com/169398">
            Idris Kulubi
          </a>{" "}
          with{" "}
          <a className="footer-link" href="https://agify.io/">
            agify.io
          </a>{" "}
          and{" "}
          <a className="footer-link" href="https://genderize.io/">
            genderize.io
          </a>
          .
